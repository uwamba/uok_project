...
urlpatterns = [
    ...
    path('upload_monitoring_message/', views.upload_monitoring_message, name='upload_monitoring_message'),
    ...
    path('get_messages/<int:test_id>/', views.get_messages, name='get_messages'),
